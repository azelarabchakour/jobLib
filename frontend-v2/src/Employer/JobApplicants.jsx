...
export default function JobApplicants() {
  ...
  function setRating(score) {
    if (score > 90) return <Rating value={5} readonly ratedColor="blue" />;
      ...
      return <Rating value={3} readonly ratedColor="yellow" />;
          ...
          <Card color="transparent" className="w-full max-w-[26rem] p-2">
            ...
            <CardBody className="mb-6 p-0">
              <div className="flex items-center justify-between ">
                ...
                <Button onClick={() => handleRefuseApplication(application.id)}>
                  Refuse{" "}
                </Button>
                <Button onClick={() => DownloadResume(application.employee.id)}>
                  Download Resume{" "}
                </Button>
              </div>
            </CardBody>
