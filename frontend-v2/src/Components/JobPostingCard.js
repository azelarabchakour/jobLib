...
export default function JobPostingCard(props) {
  ...
  return (
    ...
    {/* <Card className="w-3/5  shadow-lg">
      <CardHeader floated={false} className="bg-mantis-50">
        <Typography variant="h5"> Software Engineer Developper</Typography>
      </CardHeader>
    ...
    >
      <CardBody>
        ...
        <Typography className="truncate-3-lines text-mantis-950">
