                ...
                <div className="relative -mx-4 flex items-center justify-between">
                    ...
                    <div className="flex items-center justify-end pr-16 lg:pr-0 mr-4">
                        <label
                            ...
                            className="inline-flex cursor-pointer items-center mr-4"
                        ...
                        >
                            ...
                            />
                            <span className={`block text-white ${isDarkMode ? 'dark:hidden' : 'dark:block'}`}>
                                {/* Light mode icon */}
                                <svg
                            ...
                            <span className={`hidden text-white ${isDarkMode ? 'dark:block' : 'dark:hidden'}`}>
                                {/* Dark mode icon */}
                                <svg
                                    className="fill-current"
                                    width="24"
