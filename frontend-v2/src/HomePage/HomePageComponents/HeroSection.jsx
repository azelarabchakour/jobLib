...
const HeroSection = () => {
    return (
        <div id="home" className="relative overflow-hidden bg-primary pt-[100px] md:pt-[130px] sm:pt-[100px] lg:pt-[100px] mt-0 md:mt-[30px] lg:mt-0 h-screen" style={{ backgroundColor: '#6a7fc1' }}>
