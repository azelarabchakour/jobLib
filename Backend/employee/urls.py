...
# get all matched jobs for the logged in employee
router.register('matchedJobs', views.MatchedJobsViewSet,
                basename='matchedjobs')
...
urlpatterns = [
    ...
    path('home/', views.home, name='getJobs'),
    ...
    path('getCv/<int:pk>',views.getCv, name='getCv'),
